...
final class GuidedInstallerServiceTests: XCTestCase {
    ...
    func testRejectsReleaseWithoutDigestOrWithMultipleDMGs() {
        ...
        let multiple = """
        {"tag_name":"v1.0.4","assets":[{"name":"a.dmg","browser_download_url":"https://github.com/himudigonda/Voqora/releases/download/v1.0.4/a.dmg","size":1,"digest":"sha256:\(String(repeating: "a", count: 64))"},{"name":"b.dmg","browser_download_url":"https://github.com/himudigonda/Voqora/releases/download/v1.0.4/b.dmg","size":1,"digest":"sha256:\(String(repeating: "b", count: 64))"}]}
        """.data(using: .utf8)!
    ...
    func testVerificationRejectsSizeAndDigestMismatch() throws {
        ...
        let matching = GuidedInstallerService.ReleaseArtifact(version: "1.0.4", name: "Voqora.dmg", downloadURL: GuidedInstallerService.releasePageURL, byteCount: 6, sha256: good)
        XCTAssertNoThrow(try GuidedInstallerService.verify(file, matches: matching))

        let wrongSize = GuidedInstallerService.ReleaseArtifact(version: "1.0.4", name: "Voqora.dmg", downloadURL: GuidedInstallerService.releasePageURL, byteCount: 7, sha256: good)
